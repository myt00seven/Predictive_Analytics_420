...
Here is the model that I log some of the predictos to adjust the heavy tailed. 
```{r}
...
# Problem 2
## Prob 2(a) 
Q:Use 10-fold cross-validation to find the best combination of shrinkage parameter $\lambda$ and number of hidden nodes.
